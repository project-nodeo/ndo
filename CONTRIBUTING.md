Contributing to Nodeo Core
============================

The Nodeo Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Nodeo Core project, and is not to be
confused with overall Nodeo Network Protocol consensus changes.

Whether a pull request is merged into Nodeo Core rests with the project merge
...
Patches that change Nodeo consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nodeo consensus, it must have been
...
The project leader is the release manager for each Nodeo Core release.
