...
RESOURCES += src/qt/nodeo.qrc src/qt/nodeo_locale.qrc

TRANSLATIONS += src/qt/locale/nodeo_bg.ts \
                src/qt/locale/nodeo_de.ts \
                src/qt/locale/nodeo_en.ts \
                src/qt/locale/nodeo_es.ts \
                src/qt/locale/nodeo_fi.ts \
                src/qt/locale/nodeo_fr.ts \
                src/qt/locale/nodeo_it.ts \
                src/qt/locale/nodeo_ja.ts \
                src/qt/locale/nodeo_pl.ts \
                src/qt/locale/nodeo_pt.ts \
                src/qt/locale/nodeo_ru.ts \
                src/qt/locale/nodeo_sk.ts \
                src/qt/locale/nodeo_sv.ts \
                src/qt/locale/nodeo_vi.ts \
                src/qt/locale/nodeo_zh_CN.ts \
                src/qt/locale/nodeo_zh_TW.ts
