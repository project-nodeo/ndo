...
In order to support loading of multiple wallets in nodeo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nodeo.cpp.
...
Changes to nodeo.cpp
----------------------
nodeo.cpp is the entry point into nodeo-qt, and as such, will require some minor modifications to provide hooks for
