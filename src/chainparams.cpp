...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000997c935b8b0c3455297236fa282fa637983489e99080d8ef1b0b31e62c6"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1544685129, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("042be70a3fc1a4ed52b0ac094b46b132ceddac8420713b718fdb4e8f9c2e097f0840bb405d0f7ffd2ad9bbc55208c603fa4a51aff99e582b8b7c78bf88e0444b9c");
        nDefaultPort = 41960;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 Nodeo starting difficulty is 1 / 2^12
        ...
        nZerocoinStartTime = 1644685129;
        nBlockEnforceSerialRange = 1; //Enforce serial range starting this block
        nBlockRecalculateAccumulators = ~1; //Trigger a recalculation of accumulators
        nBlockFirstFraudulent = ~1; //First block that bad serials emerged
        nBlockLastGoodCheckpoint = ~1; //Last valid accumulator checkpoint
        const char* pszTimestamp = "Samsung Plans to Integrate Crypto Cold Storage in its S10 Series - Dec 2018";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04d2647af50bc5ca97f084bfa907d44b880f17858e7f6315e386a0cb396eb358d9662f188c3770531bfcbdd9c278f138ddff9040dede1199541d036c98d7a27707") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1544685129;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1653676;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000997c935b8b0c3455297236fa282fa637983489e99080d8ef1b0b31e62c6"));
        assert(genesis.hashMerkleRoot == uint256("0xd0a2c92bf50619c606d01380772e1a2098b939627e5519fb586b4a99c0561123"));

	vSeeds.push_back(CDNSSeedData("209.250.254.103", "209.250.254.103"));
        vSeeds.push_back(CDNSSeedData("199.247.30.145", "199.247.30.145"));
        vSeeds.push_back(CDNSSeedData("95.179.182.199", "95.179.182.199"));
	...
	strSporkKey = "0440EF57B2068F882BFB44BBFF28C764364F14A359893D7CA4C60D3FD96556340AFEBEC2DC0671C515205CB326DD2852913E5F0F264830941A21D6CED9D4345D93";
        strObfuscationPoolDummyAddress = "nT564y1MWBAQWdAA3f7WmGnuiQDsNeQugn";
        nStartMasternodePayments = 1544685129;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Nodeo: 1 day
        nTargetSpacing = 1 * 60;  // Nodeo: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet nodeo addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet nodeo script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet nodeo BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet nodeo BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet nodeo BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Nodeo: 1 day
        nTargetSpacing = 1 * 60;        // Nodeo: 1 minutes
