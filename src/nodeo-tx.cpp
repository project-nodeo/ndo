...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nodeo Core nodeo-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nodeo-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nodeo transaction") + "\n" +
                               "  nodeo-tx [options] -create [commands]   " + _("Create hex-encoded nodeo transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nodeo transaction
