                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Nodeo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nodeo address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nodeo: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Nodeo Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nodeo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nodeo"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nodeo addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nodeo addresses"));
    ...
    openAction->setStatusTip(tr("Open a Nodeo: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nodeo Core help message to get a list with possible Nodeo command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Nodeo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nodeo network", "", count));
}
...
{
    QString strTitle = tr("Nodeo Core"); // default title
...
/** Creates context menu, its actions, and nodeos up all the relevant signals for mouse events. */
