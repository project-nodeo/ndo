...
/** Utility functions used by the Nodeo Qt UI.
 */
namespace GUIUtil
{
...
// Render Nodeo addresses in monospace font
...
// Parse "nodeo:" URI into recipient object, return true on successful parsing
