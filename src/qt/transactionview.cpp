                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Nodeo from zNDO"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zNDO"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zNDO));
