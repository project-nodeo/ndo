...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Nodeo features */
        {"nodeo", "masternode", &masternode, true, true, false},
        {"nodeo", "listmasternodes", &listmasternodes, true, true, false},
        {"nodeo", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nodeo", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nodeo", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nodeo", "masternodedebug", &masternodedebug, true, true, false},
        {"nodeo", "startmasternode", &startmasternode, true, true, false},
        {"nodeo", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nodeo", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nodeo", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nodeo", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nodeo", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nodeo", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nodeo", "mnbudget", &mnbudget, true, true, false},
        {"nodeo", "preparebudget", &preparebudget, true, true, false},
        {"nodeo", "submitbudget", &submitbudget, true, true, false},
        {"nodeo", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nodeo", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nodeo", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nodeo", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nodeo", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nodeo", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nodeo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nodeo", "checkbudgets", &checkbudgets, true, true, false},
        {"nodeo", "mnsync", &mnsync, true, true, false},
        {"nodeo", "spork", &spork, true, true, false},
        {"nodeo", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"nodeo", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use nodeod, or the -server option to nodeo-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> nodeo-cli " + methodname + " " + args + "\n";
}
